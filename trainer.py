...
from networks import BiDepthDecoder, BiDepthDecoder2, LiteMono, ReMono,VitDepthDecoder,DepthDecoder, ReMonov2
...
class Trainer:
    def __init__(self, options):
        ...
        if decoder in (DepthDecoder, BiDepthDecoder, BiDepthDecoder2):
